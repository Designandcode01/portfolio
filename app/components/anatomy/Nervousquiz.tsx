...
import { nervousdata } from './nervousdata'; // Import the quiz data



const Nervousquiz: React.FC = () => {
  const { questions } = nervousdata;
    ...
    <div className="bg-slate-500 flex flex-col justify-center items-center mt-7">
      ...
      {!isQuizStarted ? (
        <div className='start-screen'>
          ...
          <h1>Nervous System (Neuroanatomy)</h1>
