...
import { cartilagedata } from './cartilagedata'; // Import the quiz data



const Cartilagequiz: React.FC = () => {
  const { questions } = cartilagedata;
