...
import { H1cellmembranedata } from './H1cellmembranedata'; // Import the quiz data



const H1cellmembrane: React.FC = () => {
  const { questions } = H1cellmembranedata;
