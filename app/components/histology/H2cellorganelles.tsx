...
import { H2cellorganellesdata } from './H2cellorganellesdata'; // Import the quiz data



const H2cellorganelles: React.FC = () => {
  const { questions } = H2cellorganellesdata;
...
export default H2cellorganelles;
