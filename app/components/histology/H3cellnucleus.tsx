...
import { H3cellnucleusdata } from './H3cellnucleusdata'; // Import the quiz data



const H3cellnucleus: React.FC = () => {
  const { questions } = H3cellnucleusdata;
