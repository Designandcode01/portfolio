...
import { H5connectivetissuedata } from './H5connectivetissuedata'; // Import the quiz data



const H5connectivetissue: React.FC = () => {
  const { questions } = H5connectivetissuedata;
...
export default H5connectivetissue;
