...
import { E5embryonicperioddata } from './E5embryonicperioddata'; // Import the quiz data



const E5embryonicperiod: React.FC = () => {
  const { questions } = E5embryonicperioddata;
...
export default E5embryonicperiod;
