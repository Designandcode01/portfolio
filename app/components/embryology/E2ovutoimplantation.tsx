...
import { E2ovutoimplantationdata } from './E2ovutoimplantationdata'; // Import the quiz data



const E2ovutoimplantation: React.FC = () => {
  const { questions } = E2ovutoimplantationdata;
    ...
    <div className="bg-slate-500 flex flex-col justify-center items-center mt-7">
      ...
      {!isQuizStarted ? (
        <div className='start-screen'>
          ...
          <h1>Ovulation to Implantation</h1>
...
export default E2ovutoimplantation;
