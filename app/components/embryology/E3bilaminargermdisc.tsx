...
import { E3bilaminargermdiscdata } from './E3bilaminargermdiscdata'; // Import the quiz data



const E3bilaminargermdisc: React.FC = () => {
  const { questions } = E3bilaminargermdiscdata;
...
export default E3bilaminargermdisc;
