...
import { E4trilaminargermdiscdata } from './E4trilaminargermdiscdata'; // Import the quiz data



const E4trilaminargermdisc: React.FC = () => {
  const { questions } = E4trilaminargermdiscdata;
...
export default E4trilaminargermdisc;
