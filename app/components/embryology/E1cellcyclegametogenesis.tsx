...
import { E1cellcyclegametogenesisdata } from './E1cellcyclegametogenesisdata'; // Import the quiz data



const E1cellcyclegametogenesis: React.FC = () => {
  const { questions } = E1cellcyclegametogenesisdata;
    ...
    <div className="bg-slate-500 flex flex-col justify-center items-center mt-7">
      ...
      {!isQuizStarted ? (
        <div className='start-screen'>
          ...
          <h1>Cell Cycle Gametogenesis</h1>
...
export default E1cellcyclegametogenesis;
